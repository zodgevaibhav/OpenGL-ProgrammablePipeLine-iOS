...
@implementation MyView
{
    ...
    GLuint vao_quad;
    GLuint gVao_quads_tilted;

    GLuint vbo_quad_position;
    GLuint vbo_quad_tilted_position;
...
-(id)initWithFrame:(CGRect)frame;
{
    ...
    if(self)
    {
       ...
       // quad_texture=[self loadTextureFromBMPFile:@"Smily" :@"bmp"];
        ...
        glGenVertexArrays(1, &gVao_quads_tilted);
        glBindVertexArray(gVao_quads_tilted);
        
        glGenBuffers(1, &vbo_quad_tilted_position);
        glBindBuffer(GL_ARRAY_BUFFER, vbo_quad_tilted_position);
        glBufferData(GL_ARRAY_BUFFER, sizeof(quadTilted), quadTilted, GL_STATIC_DRAW);
...
-(void)drawView:(id)sender
{
    ...
    modelViewMatrix=vmath::translate(-1.0f, 0.0f, -4.0f);
 ...
 //*********************** Tilted Quads *****************************
    ...
    modelViewMatrix=vmath::translate(-0.5f, 0.0f, -4.0f);
