...
@implementation MyView
{
    ...
    GLfloat textureQuadsVertices[8];
    int keyPressed;
...
-(void)drawView:(id)sender
{
    ...
    {
        textureQuadsVertices[0] = 1.0f;
        textureQuadsVertices[1] = 1.0f;
        textureQuadsVertices[2] = 0.0f;
    ...
    {
        textureQuadsVertices[0] = 2.0f;
        textureQuadsVertices[1] = 2.0f;
        textureQuadsVertices[2] = 0.0f;
